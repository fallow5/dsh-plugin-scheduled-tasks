...
export function buildCreateInput(args: {
	...
	return {
		input: {
			...
			...(args.effective_from === undefined || typeof args.effective_from !== "string"
				? {}
			...
			agentCtx.tools.register(
				defineTool({
					...
					parameters: {
						...
						effective_from: {
							type: "string",
							description: "Optional ISO date from which the task is effective (e.g. 2026-01-01). Leave absent for always.",
						},
						effective_until: {
							type: "string",
